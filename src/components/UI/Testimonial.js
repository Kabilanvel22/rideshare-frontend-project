    ...
    <Slider {...settings}>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Ramya</h6>
            <p className="section__description">Customer</p>
          </div>
        </div>
      </div>
      ...
      <div className="testimonial py-4 px-3">
        <p className="section__description">
        Great service, especially since we were delayed searching for luggage that did not arrive. Driver waited almost an hour and then drove us by some landmarks of the beautiful Barcelona on our route to the ship.
        </p>
      ...
      <div className="testimonial py-4 px-3">
        <p className="section__description">
        on arrival the service was great with the driver waiting in the arrivals lounge. However on return journey the driver was delayed by 15 minutes, and there was no communication from the driver or the taxi company. We had to phone the company twice to get the information
        </p>
